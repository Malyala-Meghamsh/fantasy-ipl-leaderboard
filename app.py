...
def _run_pipeline_thread():
    try:
        ...
        import importlib, daily_ipl_fantasy
        importlib.reload(daily_ipl_fantasy)
        run_pipeline = daily_ipl_fantasy.run_pipeline
...
def debug_screenshot():
    ...
    path = "/tmp/debug_login.png"
    if os.path.isfile(path):
        return send_file(path, mimetype="image/png")
    return "No screenshot available yet. Run the pipeline first.", 404
